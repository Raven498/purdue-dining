...
showDataBtn.addEventListener('click', (e) => {
    e.preventDefault();
    let diningDate = document.getElementById('dining-date').value;
    let diningLocation = document.getElementById('diningLocation').value;
    ...
    axios.get(`http://8081/menu/${diningLocation}/${mealType}/${diningDate}`)
